...
gnome-terminal -- bash -c "echo 'This is Pizza Generator!';       cd src/pizza_service;   poetry install; alembic upgrade head; poetry run uvicorn app:app --host 0.0.0.0 --port 8000 --reload; read -p 'Press Enter to stop...'"
